...
const NavDropdown = ({ isHovered, isClicked, dropdownItems, dropdownAlignment = "center" }) => {
  ...
  return (
    <>
      <div className={`absolute rounded-xl w-max bg-white top-full ${dropdownAlignmentClasses} grid ${isHovered || isClicked ? "grid-rows-[1fr] shadow-2xl p-4" : "grid-rows-[0fr]"} transition-all duration-200 md:static md:rounded-none md:w-full md:shadow-none md:pl-8 md:py-0`}>
