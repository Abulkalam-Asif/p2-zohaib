...
const LinkButton2 = ({ text, href = "#", icon, isSidebarOut }) => {
  return (
    <>
      <Link href={href} className='flex items-center font-medium text-base text-zinc-700 px-3 py-2 hocus:bg-themeColor2Light rounded whitespace-nowrap transition-all duration-200'>
