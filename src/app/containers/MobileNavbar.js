...
const MobileNavbar = ({ isMobNavbarOut }) => {
  ...
  return (
    <nav className={`hidden md:block bg-white fixed w-full h-screen ${isMobNavbarOut ? "top-0" : "-top-full"} transition-all duration-500 left-0 right-0 z-10 pt-24 overflow-y-auto`}>
