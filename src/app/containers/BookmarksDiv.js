    ...
    <>
      <div className='flex flex-col gap-y-8'>
        ...
        <div className='grid grid-cols-6 gap-x-4 gap-y-8 px-8'>
          ...
          <button onClick={toggleBookmarkBox} className='w-full flex flex-col items-center gap-y-3 hocus:bg-themeColorMedium p-4 rounded-xl'>
        ...
        </div>
        {
          ...
          <>
            ...
            <div className='fixed w-1/2 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-white rounded-xl shadow-3xl z-[99]'>
              <div className='flex items-center justify-between px-6 pt-4 pb-3 border-b-2 border-themeColor2Light'>
              ...
              <form>
                ...
                <div className='flex justify-between border-t-2 border-t-themeColor2Light px-6 py-6'>
